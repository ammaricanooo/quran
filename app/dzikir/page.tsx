                    ...
                    <div className="flex bg-black/20 p-1 rounded-xl border border-white/5">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-tight transition-all ${activeTab === cat.id ? "bg-primary-2 text-white shadow-lg" : "text-gray-500"
                                    }`}
                            >
